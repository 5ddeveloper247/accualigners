                    ...
                    <div class="col-12 float-right mb-1">
                        ...
                        <table class="table table-striped table-bordered responsive ideaecom-datatable-pag ">
                            ...
                            @foreach($doctors as $doctor)
                                <tr data-aeshaz-select-id="{{$doctor->id}}">
                                    <td class="select-td">{{$doctor->name}}</td>
                                    <td class="select-td">{{$doctor->email}}</td>
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item RolePermissionUpdate" href="{{url(Request()->path().'/'.$doctor->id.'/edit')}}">Edit</a>
                                                <a class="dropdown-item delete-confirm-alert RolePermissionDelete" href="javascript:void(0)" data-id="{{$doctor->id}}">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
