            ...
            <div class="col-xl-12 ">
                <div class="row">
                    ...
                    <div class="col-xl-5 mb-30 bgcolorbordertxt">
                        ...
                        <a class="btn bgcolor float-right m-1 text-white  addcase" onclick="editFunction()">Add New
                            Doctor<i class="bi bi-plus-circle"></i></a>
                                ...
                                <table class="table tablerow" id="example" style="width:100% !important">
                                    ...
                                    @foreach($doctors as $doctor)
                                        <tr>
                                            ...
                                            <td><a class="btn_edit" onclick="editFunction({{$doctor->id}})"><i
                    ...
                    <div class="col-md-12 px-4 brdall py-4">
                        ...
                        <div class="row m-0  py-4 mt-3" style="border:1px dashed #e3e3e3;border-radius: 8px;">
                            <div class="col-md-3 bold ">
                                ...
                                <img src="{{asset('vendors/images/gallery.png')}}" id="output"
