                            ...
                            <div class="aeshaz-filter">
                                <form action="{{url(Request()->path())}}" id="filter-form" method="get">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <button type="submit" class="btn btn-md btn-primary white ml-1"> Search
                                            </button>
                                ...
                                @foreach($patients as $patient)
                                    <tr data-aeshaz-select-id="{{$patient->id}}">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button type="button"
                                                        class="btn btn-sm round btn-primary btn-glow dropdown-toggle action-btn"
                                                        data-toggle="dropdown" aria-haspopup="true"
                                                        aria-expanded="true"><i class="ft-settings"></i> Action
                                                </button>
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item RolePermissionUpdate"
                                                       href="{{url(Request()->path().'/'.$patient->id.'/edit')}}">Edit</a>
                                                    <a class="dropdown-item delete-confirm-alert RolePermissionDelete"
                                                       href="javascript:void(0)" data-id="{{$patient->id}}">Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
