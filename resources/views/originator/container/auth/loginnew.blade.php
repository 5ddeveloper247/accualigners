...
<div class="app-content content">
    <div class="content-wrapper">
        ...
        <div class="content-body">
            <section class="flexbox-container" style="overflow:auto; height: auto;">
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="col-md-3 col-10 p-0">
                        <div class="row">
                            <div class="col-12 text-center mb-2">
                                <div class="p-1 login-logo" style="height: 200px; display: flex;  align-items: center;"><img src="{{storageUrl_h(trans('siteConfig.setting.logoDarkVertical'))}}" alt="IdeaEcom logo"></div>
                                ...
                                <div class="card border-grey border-lighten-3 m-0 p-2">
                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            ...
                                            <div class="col-12 text-center mt-2 p-0" style="z-index: 9;">
                                                    <a href="https://www.accualigners.com/" class="btn btn-primary btn-lg btn-block" >Home</a>
                                            </div>
                                            <div class="col-12 text-center">
                                                <a href="{{ url('password/reset') }}" class="btn btn-link box-shadow-0 px-0 text-white-80">Forgot
                                                    password?</a>
                                            </div>
                                             <div class="col-12 text-center mt-2">
                                                <a href="{{ url('signup'); }}" class="card-link text-light">Become a Member? <span class="text-info"><strong>JOIN NOW</strong></span> </a>
                                            </div>
                                        </div>
                                    </div>
