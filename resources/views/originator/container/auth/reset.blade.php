                    ...
                    <div class="col-md-3 col-10 p-0">
                        <div class="row">
                            <div class="col-12 text-center mb-2">
                                ...
                                <h6 class="card-subtitle font-medium-1 pt-1 text-light"><span>Reset your account password</span></h6>
                            </div>
                            ...
                            <div class="col-12 text-center mt-2">
                                <a href="{{ url('signup'); }}" class="card-link text-light">Become a Member? <span
