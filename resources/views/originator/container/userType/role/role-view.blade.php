            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">{{isset($getUserTypeData['name']) ? ucwords(strtolower($getUserTypeData['name']."'s")) : ''}} Role</li>
                </ol>
              </div>
            </div>
          </div>
                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    ...
                                                                    @if($getUserTypeData['is_package'])
                                                                        @if(checkNavPermission([12]))
                                                                            <a class="dropdown-item" href="{{url(Request()->path().'/'.$getTableRow['id'].'/package/')}}">Packages</a>
                                                                        @endif
                                                                    @endif
