            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">{{isset($getRoleData['name']) ? ucwords(strtolower($getRoleData['name']."'s")) : ''}} Permission</li>
                </ol>
              </div>
            </div>
          </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header  bg-hexagons">
                                <h4 class="card-title">{{isset($getRoleData['name']) ? $getRoleData['name']."'s" : ''}} Permission</h4>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($getTableData as $getTableRow)
                                                <tr data-aeshaz-select-id="{{$getTableRow['id']}}">
                                                    ...
                                                    <td>
                                                        <center> {!! $getTableRow['insert'] == 1 ? '<span class="badge badge badge-success mr-2">Yes</span>' : '<span class="badge badge badge-warning mr-2">No</span>' !!} </center>
                                                    </td>
                                                    <td>
                                                        <center> {!! $getTableRow['update'] == 1 ? '<span class="badge badge badge-success mr-2">Yes</span>' : '<span class="badge badge badge-warning mr-2">No</span>' !!} </center>
                                                    </td>
                                                    <td>
                                                        <center> {!! $getTableRow['delete'] == 1 ? '<span class="badge badge badge-success mr-2">Yes</span>' : '<span class="badge badge badge-warning mr-2">No</span>' !!} </center>
                                                    </td>
                                                    <td>
                                                        <center> {!! $getTableRow['view'] == 1 ? '<span class="badge badge badge-success mr-2">Yes</span>' : '<span class="badge badge badge-warning mr-2">No</span>' !!} </center>
                                                    </td>
                                                    <td>
