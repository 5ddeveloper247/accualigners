                ...
                <div class="col-xl-12 ">
                    ...
                    <div class="col-xl-5 mb-30">
                        ...
                        <div class="col-xl-4 mb-30 bgcolorbordertxt">
                            ...
                            <a class="btn bgcolor float-right m-1 text-white  addcase" id="addClinic" onclick="editFunction()">New Clinic<i class="bi bi-plus-circle"></i></a>
                           ...
                           <div class="table-responsive">
                             <table class="table tablerow">         
                                 <thead>
                                     ...
                                     <th  style="font-size: 13px !important;"><span style="visibility: hidden">Clinicde </span>Clinic</th>
                                     <th  style="font-size: 13px !important;"><span style="visibility: hidden">Clinicdeied </span>Address</th>
                                     <th  style="font-size: 13px !important;"><span style="visibility: hidden">deie </span>Contact Person</th>
                                ...
                                <div class="ac">
                                    <h2 class="ac-header">
                                        <span class=" table-responsive">
                                            ...
                                            <thead>
                                                <tr style="width:100%;">
                                                <th  class=" checkboxbandka" style="display: none;width:3%;position: relative;top: -17px;">
                                                <input type="checkbox"  id="a{{$a++}}" value="{{$clinic->id}}"></td>
                                                ...
                                                <td class="ac-trigger" style="width:100px !important;padding-left:40%; padding:19%;float: right;"><i class="bi bi-pencil-square" onclick="editFunction('{{$clinic->id}}')"></i></td>
                                                </tr>
                                            </thead>
                                            </table>
                                        </span>
                                    ...
                                    @if($clinicDoctor->pivot->deleted_at == null )
                                     ...
                                     <tr>
                                            ...
                                            <i style="margin-top:15px;" class="bi bi-three-dots-vertical dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></i>
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" style="text-align: center;padding: 0;text-decoration: none;" onclick="showDoctors('{{$clinicDoctor->pivot->id}}','{{$clinic->id}}')">Edit</a>
                                                <a class="dropdown-item" style="text-align: center;padding: 0;text-decoration: none;" onclick="deleteClinicDoctor('{{$clinicDoctor->pivot->id}}')">Delete</a>
                                            </div>
                                            </td>
                                           <td></td>
                                           <td></td>
                                           ...
                                           <td></td>
                                                ...
                                                <tr>
                                                    <td class="monday">
                                 <a style="text-decoration: none;">Monday<span class="{{($clinicDoctor->pivot->monday_time == null)? 'no':'yes'}}">{{($clinicDoctor->pivot->monday_time == null)? 'no':'yes'}}</span>  </a>
                                                        <br>
                                                        <span class="spando" style="display: inline-block;height: 37px;">
                                                        {{$clinicDoctor->pivot->monday_time}}
                                                        </span>
                                                    </td>      
                                                    <td class="tuesday">
                                 <a style="text-decoration: none;">Tuesday<span class="{{($clinicDoctor->pivot->tuesday_time == null)? 'no':'yes'}}">{{($clinicDoctor->pivot->tuesday_time == null)? 'no':'yes'}}</span>  </a>
                                                        <br>
                                                        <span class="spando"  style="display: inline-block;height: 37px;">
                                                    ...
                                                    <td class="wednesday">
                                 <a style="text-decoration: none;">Wednesday<span class="{{($clinicDoctor->pivot->wednesday_time == null)? 'no':'yes'}}">{{($clinicDoctor->pivot->wednesday_time == null)? 'no':'yes'}}</span>  </a>
                                                        <br>
                                                        <span class="spando"  style="display: inline-block;height: 37px;">
                                            ...
                                            <td class="thursday">
                                 <a style="text-decoration: none;">Thursday<span class="{{($clinicDoctor->pivot->thursday_time == null)? 'no':'yes'}}">{{($clinicDoctor->pivot->thursday_time == null)? 'no':'yes'}}</span>  </a>
                                                        <br>
                                                        <span class="spando"  style="display: inline-block;height: 37px;">
                                                    ...
                                                    <td class="friday">
                                 <a style="text-decoration: none;">Friday<span class="{{($clinicDoctor->pivot->friday_time == null)? 'no':'yes'}}">{{($clinicDoctor->pivot->friday_time == null)? 'no':'yes'}}</span>  </a>
                                                        <br>
                                                        <span class="spando"  style="display: inline-block;height: 37px;">
                                                    ...
                                                    <td class="saturday">
                                 <a style="text-decoration: none;">Saturday<span class="{{($clinicDoctor->pivot->saturday_time == null)? 'no':'yes'}}">{{($clinicDoctor->pivot->saturday_time == null)? 'no':'yes'}}</span>  </a>
                                                        <br>
                                                        <span class="spando"  style="display: inline-block;height: 37px;">
                                                        {{$clinicDoctor->pivot->saturday_time}}
                                                        </span>
                                                    </td>    <td class="sunday">
                                 <a style="text-decoration: none;">Sunday<span class="{{($clinicDoctor->pivot->sunday_time == null)? 'no':'yes'}}">{{($clinicDoctor->pivot->sunday_time == null)? 'no':'yes'}}</span>  </a>
                                                        <br>
                                                        <span class="spando"  style="display: inline-block;height: 37px;">
    ...
    <div class="row m-0">
        ...
        <div class="col-md-5 bg-white popadd">
            ...
            <div class="row px-4 mb-5 ">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12 bold p-0">
                            ...
                            <p style="font-size: 13px;color: #202429;font-weight: 300;">Complete the information related to the clinic</p>
                ...
                <form class="form-horizontal" method="post" id="frmclinic" action="" enctype="multipart/form-data" novalidate>
                    <div class="row">
                    ...
                    <div class="row  pt-4">
                        ...
                        <div class="col-md-6 mb-4 bold ">
                            <span>Country</span>
                            <select class="select2 form-control" id="country_id" name="country_id" style="font-size: 12px;color: #858181;" required>
                        ...
                        <div class="col-md-12 mb-4 bold ">
                            <span>Address*</span>
                            <input type="text" name="address" id="address"  class="form-control" placeholder="Enter Here" required>
                        </div>
                        <div class="col-md-6 mb-4 bold ">
                            <span>State</span>
                            <select class="select2 form-control" id="state_id" name="state_id" required style="font-size: 12px;color: grey;" required>
                                        <option>Select State</option>
                            </select>  
                        </div>
                        <div class="col-md-6 mb-4 bold ">
                            <span>City</span>
                            <select class="select2 form-control" id="city_id" name="city_id" required style="font-size: 12px;color: grey;" required>
                                        <option>Select City</option>
                            </select>
                        </div>
                        <div class="col-md-6 mb-4 bold ">
                            <span>Contact Person Name*</span>
                            <input type="" name="contact_person_name" id="contact_person_name" class="form-control" placeholder="Enter Here" required>
                        </div>
                        <div class="col-md-6 mb-4 bold ">
                            <span>Contact Person Email*</span>
                            <input type="email" name="contact_person_email" id="contact_person_email" class="form-control" placeholder="Enter Here" required>
                        </div>
                        <div class="col-md-6 mb-4 bold ">
                            <span>Contact Person Number*</span>
                            <input type="number" name="contact_person_number" id="contact_person_number" class="form-control" placeholder="Enter Here" required>
                        </div>
                ...
                <form class="form-horizontal" method="post" id="frmdoctor" action="" enctype="multipart/form-data" novalidate>
                     <div class="row m-0 ">
                    ...
                    <div class="row m-0 ">
                        <div class="col-md-5 mb-4 bold validateTime ">
                            ...
                            <input type="" name="monday_time_from" class="form-control" placeholder="08:00" autocomplete="off" id="monday_time_from" style="margin-top:3px;">
                        </div>
                        <div class="col-md-5 mb-4 bold validateTime ">

                            <span style="font-weight: bold;visibility: hidden;">Timings</span>
                            <input type="" name="monday_time_to" id="monday_time_to" class="form-control" autocomplete="off" placeholder="13:00">
                        </div>

                        <div class="col-md-2 mb-4 bold ">
                            <div class="custom-control custom-switch" style="margin-top: 2.7rem;">
                                <input type="checkbox" class="custom-control-input" id="customSwitches1" onclick="ChangeVisibility('monday',this)" autocomplete="off" checked>
                    ...
                    <div class="row m-0 ">
                        <div class="col-md-5 mb-4 bold validateTime ">
                            ...
                            <input type="" name="tuesday_time_from" id="tuesday_time_from" class="form-control"  autocomplete="off" placeholder="08:00" style="margin-top:3px;">
                        </div>
                        <div class="col-md-5 mb-4 bold validateTime ">

                            <span style="font-weight: bold;visibility: hidden;">Timings</span>
                            <input type="" name="tuesday_time_to" id="tuesday_time_to" class="form-control" autocomplete="off" placeholder="13:00">
                        </div>

                        <div class="col-md-2 mb-4 bold ">
                            <div class="custom-control custom-switch  " style="margin-top: 2.7rem;">
                                <input type="checkbox" class="custom-control-input" id="customSwitches2" onclick="ChangeVisibility('tuesday',this)" checked>
                    ...
                    <div class="row m-0 ">
                        <div class="col-md-5 mb-4 bold validateTime ">
                            ...
                            <input type="" name="wednesday_time_from" id="wednesday_time_from" autocomplete="off" class="form-control" placeholder="08:00"
                        ...
                        <div class="col-md-5 mb-4 bold validateTime ">
                            ...
                            <span style="font-weight: bold;visibility: hidden;">Timings</span>
                            <input type="" name="wednesday_time_to" id="wednesday_time_to" autocomplete="off" class="form-control" placeholder="13:00">
                        </div>

                        <div class="col-md-2 mb-4 bold ">
                            <div class="custom-control custom-switch" style="margin-top: 2.7rem;">
                                <input type="checkbox" class="custom-control-input" id="customSwitches3"  onclick="ChangeVisibility('wednesday',this)"  checked>
                    ...
                    <div class="row m-0 ">
                        <div class="col-md-5 mb-4 bold validateTime ">
                            ...
                            <input  name="thursday_time_from" id="thursday_time_from" autocomplete="off" class="form-control" placeholder="08:00" style="margin-top:3px;">
                        </div>
                        <div class="col-md-5 mb-4 bold validateTime ">

                            <span style="font-weight: bold;visibility: hidden;">Timings</span>
                            <input type="" name="thursday_time_to" id="thursday_time_to" autocomplete="off" class="form-control" placeholder="13:00">
                        </div>

                        <div class="col-md-2 mb-4 bold ">
                            <div class="custom-control custom-switch" style="margin-top: 2.7rem;">
                                <input type="checkbox" class="custom-control-input" id="customSwitches4" onclick="ChangeVisibility('thursday',this)" checked>
                    ...
                    <div class="row m-0 ">
                        <div class="col-md-5 mb-4 bold validateTime ">
                            ...
                            <input type="" name="friday_time_from" id="friday_time_from" autocomplete="off" class="form-control" placeholder="08:00" style="margin-top:3px;">
                        </div>
                        <div class="col-md-5 mb-4 bold validateTime ">

                            <span style="font-weight: bold;visibility: hidden;">Timings</span>
                            <input type="" name="friday_time_to" id="friday_time_to" autocomplete="off" class="form-control" placeholder="13:00">
                        </div>

                        <div class="col-md-2 mb-4 bold ">
                            <div class="custom-control custom-switch  " style="margin-top: 2.7rem;">
                                <input type="checkbox" class="custom-control-input" id="customSwitches5" onclick="ChangeVisibility('friday',this)" checked>
                    ...
                    <div class="row m-0 ">
                        <div class="col-md-5 mb-4 bold validateTime ">
                            ...
                            <input type="" name="saturday_time_from" id="saturday_time_from" autocomplete="off" class="form-control" placeholder="08:00" style="margin-top:3px;">
                        </div>
                        <div class="col-md-5 mb-4 bold validateTime ">

                            <span style="font-weight: bold;visibility: hidden;">Timings</span>
                            <input type="" name="saturday_time_to" id="saturday_time_to" autocomplete="off" class="form-control" placeholder="13:00">
                        </div>

                        <div class="col-md-2 mb-4 bold ">
                            <div class="custom-control custom-switch  " style="margin-top: 2.7rem;">
                                <input type="checkbox" class="custom-control-input" id="customSwitches6" onclick="ChangeVisibility('saturday',this)" checked>
                    ...
                    <div class="row m-0 ">
                        <div class="col-md-5 mb-4 bold validateTime ">
                            ...
                            <input type="" name="sunday_time_from" id="sunday_time_from" autocomplete="off" class="form-control" placeholder="08:00"  style="margin-top:3px;">
                        </div>
                        <div class="col-md-5 mb-4 bold validateTime ">

                            <span style="font-weight: bold;visibility: hidden;">Timings</span>
                            <input type="" name="sunday_time_to" id="sunday_time_to" autocomplete="off" class="form-control" placeholder="13:00">
                        </div>

                        <div class="col-md-2 mb-4 bold ">
                            <div class="custom-control custom-switch  " style="margin-top: 2.7rem;">
                                <input type="checkbox" class="custom-control-input" id="customSwitches7" onclick="ChangeVisibility('sunday',this)" checked>
