                                            ...
                                            <div class="card-body card-dashboard">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 <?php if ($errors->has('clinic_doctor_id')) echo 'error'; ?>">
                                                        <label>Doctor (Clinic)<span class="required">*</span></label>
                                                        <div class="controls">
                                                            <!--<select class="select2 form-control" id="clinic_doctor_id" name="clinic_doctor_id" required>-->
                                                            <select class="select2 form-control" id="clinic_doctor_id" name="clinic_doctor_id">
                                                                <option>Select Clinic</option>
                                                                @foreach($ClinicDoctors as $ClinicDoctor)
                                                                    @if(isset($ClinicDoctor->doctor->name) && isset($ClinicDoctor->clinic->name))
                                                                        <option value="{{$ClinicDoctor->id}}" 
                                                                            @if(isset($edit_values) && $edit_values->clinic_doctor_id == $ClinicDoctor->id) selected @endif >
                                                                            {{$ClinicDoctor->doctor->name . " (" . $ClinicDoctor->clinic->name . ")"}}
                                                                        </option>
                                                                    @endif
                                                                @endforeach
                                                            </select>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-12 <?php if ($errors->has('comment')) echo 'error'; ?>">
                                                        ...
                                                        @for ($i=1;$i<=9;$i++)
                                                            ...
                                                            <label class="btn">
                                                                <input type="file" name="{{'IMAGE_'.$i}}" class="hidden upload-attachment" data-type="IMAGE" data-sort="{{$i}}">
                                                    ...
                                                    <div class="form-group col-12 <?php if ($errors->has('comment')) echo 'error'; ?>">
                                                        ...
                                                        @for ($i=1;$i<=2;$i++)
                                                            ...
                                                            <label class="btn">
                                                                <input type="file" name="{{'X_RAY_'.$i}}" class="hidden upload-attachment" data-type="X_RAY" data-sort="{{$i}}">
                                                    ...
                                                    <div class="form-group col-12 <?php if ($errors->has('comment')) echo 'error'; ?>">
                                                        ...
                                                        @for ($i=1;$i<=2;$i++)
                                                            ...
                                                            <label class="btn">
                                                                <input type="file" name="{{$jaw_type.'_'.$i}}" class="hidden upload-attachment" data-type="{{$jaw_type}}" data-sort="{{$i}}">
                                                    ...
                                                    <div class="form-group col-lg-2 col-md-2 col-sm-4 col-12 <?php if ($errors->has('comment')) echo 'error'; ?>" id="other-files">
                                                        ...
                                                        <label class="btn">
                                                            <input type="file" name="OTHER" class="hidden upload-attachment" data-type="OTHER" data-sort="1">
    ...
    $(document).ready(function(){
        ...
        function readURL(input, type, sort) {
            ...
            $.ajax({
                ...
                url: '{{route("admin.case.upload-attachment")}}',
                type:"POST",
                dataType : 'json',
                data: formData,
                processData: false,
        ...
        $('body').on('change', '#clinic_doctor_id', function(){
            ...
            $.ajax({
                ...
                url:'{{route("admin.case.get-clinic-patients")}}',
                type: "POST",
                dataType: 'json',
                data:data,
                beforeSend: function () {
        ...
        $('body').on('change', '#patient_id', function(){
            ...
            $.ajax({
                ...
                url:'{{route("admin.case.get-patient-detail")}}',
                type: "POST",
                dataType: 'json',
                data:data,
                beforeSend: function () {
