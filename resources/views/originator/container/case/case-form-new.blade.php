                            ...
                            <div class="row m-0 messagedobs" >
                                <div class="col-md-12 borderbottom cheating"  >
                                    <div class="recuitment my-3">
                                        ...
                                        @if($edit_values->has_concern) <div style="border: 2px solid red;padding: 6px;float:right;color: red;"
                         ...
                         <div class="col-md-4 borderleft ">
                                ...
                                @if(!empty($edit_values->video_uploaded))
                                     ...
                                     @if ($edit_values->video_uploaded_type == 'VIDEO')
                                                    <video id="vid0"
                                                        ...
                                                        controls="controls" crossorigin="anonymous" class="vid" style="width:100%;" playsinline autoplay muted loop></video>
                                             @else
                                     ...
                                     @endif
                                                ...
                                                <div class="col-12 video_uploaded">
                                                    <button type="button" class="btn btn-block btn-primary"
                                                        id="delete_video" style="margin-top: 2px !important;width: 100%; text-align:center;"><i class="ft-trash"></i> Remove</button>
                                                </div>
                                     @endif
                            </div>
                            <!--<div class="row mt-4 ">
                            ...
                            <div class="row mt-4 ">
                                ...
                                <div class="col-md-12   p-0 px-3  pb-3">
                                    ...
                                    <input type="number" min="1" max="24" class="form-control" placeholder="Enter Here"  name="no_of_days" id="no_of_days"
                            ...
                            <div class="table-responsive">
                                <table class="table tabledozama">
                                    <thead style="background-color: #f4f5f8;">
                                        ...
                                        <th style="font-size: 10px!important;" class="case_empty" id="case_id">2</th>
                                        <td style="font-size: 8px!important;" >Order ID:</td>
                                        <th style="font-size: 10px!important;" class="case_empty" id="order_id">1</th>
                                        <td style="font-size: 8px!important;">Dentist’s Name:</td>
                                        <th style="font-size: 10px!important;"  class="case_empty" id="dentist_name">Mujtaba Fatih</th>
                                        <td style="font-size: 8px!important;">Number of trays:</td>
                                        <th style="font-size: 10px!important;"  class="case_empty" id="no_of_tray">10</th>
                                        <td style="font-size: 8px!important;">Shipping Charges:</td>
                                        <th style="font-size: 10px!important;"  class="case_empty" id="shipping_charges">0 AED</th>
                                    </thead>
                                </table>
                            </div>
                        </div>
                            ...
                            <div class="row  brdall pt-3 m-1" >
                                ...
                                <div class="col-md-12 mt-1 addressdo  my-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mt-1 addressdo ">
                                            <p style="display: inline;font-size: 12px;     display: inline;color: #8c8d8d;">City:
                                            </p>
                                        ...
                                        <div class="col-md-12 mt-1 addressdo ">
                                            <p style="display: inline;font-size: 12px;     display: inline;color: #8c8d8d;">Address:
                                            </p>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document" style="position: absolute !important;right: 30% !important;">
    ...
    <div class="alert alert-success mb-2" id="success" style="display:none" ></div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary mr-2" data-dismiss="modal" onclick="onClose()">Close</button>
        <button type="button"  class="btn bgcolor" style="color:white;" onclick="addvideolink()">Save changes</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="video_modal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document" style="position: absolute !important;right: 30% !important;">
    ...
    <div class="alert alert-success mb-2" id="success2" style="display:none" ></div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary mr-2" data-dismiss="modal" onclick="onClose()">Close</button>
        <button type="button" class="btn bgcolor" style="color:white;" onclick="uploadvideo()">Save changes</button>
      </div>
    </div>
  </div>
</div>
