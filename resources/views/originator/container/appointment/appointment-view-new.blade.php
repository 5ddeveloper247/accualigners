            ...
            <div class="col-xl-12 ">
                <div class="row">
                    ...
                    <div class="col-xl-4  fourdo mb-30 bgcolorbordertxt">
                        <a class="btn float-right mx-2 bgcolor text-white casebtn addcase">New Appointment <i
                                class="bi bi-plus-circle"></i></a>
                        <a class="btn btn bg border border-dark  btn-xl color  border-radius-8 bgcolorborder   float-right  delete"
                           style="font-size:22px;width: 93px;">Delete<i class="bi bi-trash3" style=""></i>
                            <a class="ete checkboxbandka cursor cleardo float-right"
                               style="font-size:22px;display: none;">Clear<i class="bi bi-eraser-fill"></i></a>
                        </a>
                    </div>
                </div>
                                        ...
                                        <table class="table tablerow" id="example" style="width:100% !important;">
                                            ...
                                            @foreach($appointments as $appointment)
                                                ...
                                                <!-- <td>{{$appointment->status_title}}</td> -->
                                                    ...
                                                    <td class="maindo"><a
                                                            class="inprogressbtn">{{ucfirst($appointment->status_title)}}</a>
                                                    </td>
                                                    <td><a class="btn_edit" onclick="edit('{{ $appointment->id }}')"><i
                ...
                <div class="col-md-5 bg-white pb-5 popadd">
                        ...
                        <div class="col-md-12 px-4 brdall py-4">
                            ...
                            <div class="row  pt-4">
                                <div class="col-md-6  ">
                                    ...
                                    <select class="form-select form-control" name="patient" id="patient" selected
                                            required>
                                        <option value="select">Select</option>
                                        @if(isset($patient) && !empty($patient) && $patient->count()>0)
                                            @foreach($patient as $index=>$value)
                                                <option name="patient"
                                                        value="{{ isset($value->user->id) && !empty($value->user->id) ? $value->user->id  : '-'}}">{{isset($value->user->name) && !empty($value->user->name) ? $value->user->name  : '-'}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                                <div class="col-md-6 mb-4  ">
                                    <span>Clinic</span>
                                    <select class="form-select form-control" name="clinic_doctor_id" id="client_id"
                                            selected required>
                                ...
                                <div class="col-md-6 mb-4  ">
                                    ...
                                    <select id="doctor_id" name="doctor_id" class="form-select form-control" selected
                                            required>
                                ...
                                <div class="col-md-6 mb-4  ">
                                    ...
                                    <input type="date" name="appointment_date" value="" class="form-control"
                                           id="date_appointment" placeholder="Enter Here" required>
                                </div>

                                <div class="col-md-12 mb-4  ">
                                    Appointment Time
                                    <input type="time" name="appointment_time" class="form-control" value=""
                                           id="time_appointment" placeholder="Enter Here" required>
                                </div>

                                <div class="col-md-12 b-4  ">
                                    Treatment plan*
                                    <textarea name="treatment_plan" id="treatment_plan" class="form-control"
                                              id="treatment_plan" height="200" required>
                            </textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mt-3 ">
                        <div class="col-md-12 col ">
                            ...
                            <a class="btn bg border border-radius-8 btn btn-xl color mb-5  bgcolorborder float-right mx-2"
                               style="font-size:22px;" onclick="bndka();">Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
