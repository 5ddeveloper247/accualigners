                                            ...
                                            <table class="table tablerow" id="example">
                                                ...
                                                @foreach($orders as $order)
                                                 ...
                                                 <tr>
                                                        ...
                                                        <td class="maindo"><a class="inprogressbtn">{{ucfirst($order->status)}}</a></td>
                                                ...
                                                <i class="bi bi-three-dots-vertical dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="cursor:pointer"></i>
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" style="text-align: center;padding: 0;text-decoration: none;" href=" {{ $order->order_url }}">Courier Link</a>
                                                        <a class="dropdown-item" style="text-align: center;padding: 0;text-decoration: none;" onclick="view('{{ $order->id }}')">View Details</a>
                                                        <a class="dropdown-item" style="text-align: center;padding: 0;text-decoration: none;" onclick="delete_order('{{ $order->id }}')">Delete</a>
                                ...
                                <div class="maindo table-responsive">
                                    <table class="table">
                                        <thead class="bxtekdo brdall" style="background-color: #f4f5f8;">
                                           ...
                                           line-height: 54px;"> Quantity:</span><span class="case_empty" id="quantity" style="font-size:14px!important;">1</span>
                                            </th>   
                                            <!-- <th >
                                          ...
                                          <span style="font-size:14px!important;font-weight: 300;line-height:54px;"> Total Price:</span><span class="case_empty" id="total_price" style="font-size:14px!important;"> 99 AED </span>
