...
<div class="main-container">
                    ...
                    <div class="col-xl-12 mb-30  dollar">
                        ...
                        <div class=" py-4 px-4 mt-3 borderdobx" id="currency_con">
                            @foreach($currency as $c)
                                <a class="m-1" id="currency_{{ $c->id }}">{{ $c->name }}<i class="bi bi-x-circle m-2"
                                                                                           style="cursor:pointer;"
                                                                                           onclick="delete2('currency','{{ $c->id }}')"></i></a>
                        @endforeach
                        <!-- <a class="m-1"> AED <img src="images/crosseka.png" class="mt-1"></a>    -->
                            ...
                            <a class="m-1 text-white bgcolor" data-toggle="modal" data-target="#currency_modal"
                        ...
                        <div class=" py-4 px-4 mt-3  borderdobx" id="digital_con">
                            @foreach($setting as $s)
                                @if($s->digital_scan !== null && $s->currency != null && $s->currency_id != 'null')
                                    <a class="m-1"
                                       id="digital_{{ $s->currency_id }}">{{ $s->digital_scan }} {{ $s->currency }}<i
                                            class="bi bi-x-circle m-2"
                                            onclick="delete2('digital','{{ $s->currency_id }}')"
                                            style="cursor:pointer;"></i></a>
                            @endif
                        @endforeach
                        <!-- <a class="m-1">3000 PKR<img src="images/crosseka.png" class="m-1"></a> -->
                            <a class="m-1 text-white bgcolor" onclick="Add('digital-scan')" data-toggle="modal"
                               data-target="#additional" style="cursor:pointer;">Add More
                            </a>
                        </div>
                    </div>
                        ...
                        <div class=" py-4 px-4 mt-3  borderdobx" id="international_con">
                            @foreach($setting as $s)
                                @if($s->international_courier_charges !== null && $s->currency != null && $s->currency_id != 'null')
                                    <a class="m-1"
                                       id="international_{{ $s->currency_id }}"> {{$s->international_courier_charges }} {{ $s->currency }}
                                        <i class="bi bi-x-circle m-2" style="cursor:pointer;"
                                           onclick="delete2('international','{{ $s->currency_id }}')"></i></a>
                            @endif

                        @endforeach
                        <!-- <a class="m-1">10000 PKR<img src="images/crosseka.png" class="m-1"></a>    -->
                            <a class="m-1 text-white bgcolor" onclick="Add('international')" data-toggle="modal"
                               data-target="#additional" style="cursor:pointer;">Add More
                            </a>
                        </div>
                    </div>
                        ...
                        <div class=" py-4 px-4 mt-3  borderdobx" id="aligners_con">
                            @foreach($setting as $s)
                                @if($s->aligner_kit_price !== null && $s->currency != null && $s->currency_id != 'null')
                                    <a class="m-1"
                                       id="aligners_{{ $s->currency_id }}"> {{$s->aligner_kit_price }} {{ $s->currency }}
                                        <i class="bi bi-x-circle m-2" style="cursor:pointer;"
                                           onclick="delete2('aligners','{{ $s->currency_id }}')"></i></a>
                            @endif
                        @endforeach
                        <!-- <a class="m-1">10000 PKR<img src="images/crosseka.png" class="m-1"></a>    -->

                            <a class="m-1 text-white bgcolor" onclick="Add('aligners')" data-toggle="modal"
                               data-target="#additional" style="cursor:pointer;">Add More
                            </a>
                        </div>
                    </div>
                        ...
                        <div class=" py-4 px-4 mt-3  borderdobx" id="treatment_con">
                            @foreach($setting as $s)
                                @if($s->complete_treatment_plan !== null && $s->currency != null && $s->currency_id != 'null')
                                    <a class="m-1 abtn"
                                       id="treatment_{{ $s->currency_id }}"> {{$s->complete_treatment_plan }} {{ $s->currency }}
                                        <i class="bi bi-x-circle m-2" style="cursor:pointer;"
                                           onclick="delete2('treatment','{{ $s->currency_id }}')"></i></a>
                            @endif
                        @endforeach

                        <!-- <a class="m-1">120000 PKR<img src="images/crosseka.png" class="m-1"></a>    -->

                            <a class="m-1 text-white bgcolor abtn" onclick="Add('treatment-plan')" data-toggle="modal"
                               data-target="#additional" style="cursor:pointer;" style="">Add More
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="additional" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
         aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group digital-scan">
                        ...
                        <input type="number" min="0" class="form-control digital-scan" id="digital_scan"
                               aria-describedby="emailHelp" placeholder="Enter Digital_scan amount">
                    </div>

                    <div class="form-group international">
                        <label for="exampleInputEmail1  international">International Courier Charges</label>
                        <input type="number" min="0" class="form-control  international" id="International"
                               aria-describedby="emailHelp" placeholder="International Courier Charges">
                    </div>

                    <div class="form-group aligners">
                        <label for="exampleInputEmail1  aligners">Clear Aligners Production Charges</label>
                        <input type="number" min="0" class="form-control aligners" id="Aligners"
                               aria-describedby="emailHelp" placeholder="Enter Clear Aligners Production Charges">
                    </div>

                    <div class="form-group treatment-plan">
                        <label for="exampleInputEmail1 treatment-plan">Treatment Plan</label>
                        <input type="number" min="0" class="form-control treatment-plan" id="Treatment"
                               aria-describedby="emailHelp" placeholder="Enter Treatment Plan">
                    </div>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="onClose()">Close
                    </button>
                    <button type="button" class="btn bgcolor" style="color:white;" onclick="AddAdditional()">Save
                        changes
                    </button>
                </div>
            </div>
    ...
    <div class="modal fade" id="currency_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group digital-scan">
                        ...
                        <input type="text" class="form-control digital-scan" id="currency_id" name="currency_value"
                               aria-describedby="emailHelp" placeholder="Enter currency">
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn bgcolor" style="color:white;" onclick="addcurrency()">Save
                        changes
                    </button>
                </div>
            </div>
