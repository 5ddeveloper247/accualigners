                                                        ...
                                                        <center>
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    ...
                                                                    @if(checkNavPermission([2]))
                                                                        <a class="dropdown-item" href="{{url(Request()->path().'/'.$getTableRow['id'].'/role')}}">Roles</a>
                                                                    @endif

                                                                    @if(checkNavPermission([4]))
                                                                        <a class="dropdown-item" href="{{url(Request()->path().'/'.$getTableRow['id'].'/user')}}">Users</a>
                                                                    @endif
