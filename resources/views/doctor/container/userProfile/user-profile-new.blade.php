                ...
                <div class="col-xl-12 ">
                    <div class="row">
                        ...
                        <div class="col-xl-12 mb-30  dollar">
                            ...
                            <p style="color:#4B5563;">General Profile allow you to change your profile picture and adjust your account and password information.</p>
                        ...
                        <div class="col-md-6 ">
                            ...
                            <div class="row">
                                <div class="col-xl-12 mb-30  dollar pb-1 mt-3">
                                    <button type="submit" class="btn bgcolor text-white casebtn float-right btn_update" style="margin-top: 20px;margin-right:20px;border-radius:20px;width:100px;text-align:center;">Submit</a>
                                    <!-- <a class="btn bgcolorborder float-right mx-3" style="font-size:22px;" onclick="bndka();">Cancel</a> -->
                                </div>
                            </div>
                            <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab"></div>
