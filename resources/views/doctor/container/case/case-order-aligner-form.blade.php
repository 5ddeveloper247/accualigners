...
@section('content')
    @php
        ...
        $form_action = route('doctor.case.order-aligner.store', ['case'=>$case->id]);
        
        $form_action2 = route('doctor.case.order-aligner.storeInvoice', ['case'=>$case->id]);
                                        ...
                                        <div class="card-content collapse show">
                                            <div class="card-body card-dashboard">
                                                ...
                                                <div class="row">
                                                     ...
                                                     <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 <?php if ($errors->has('address_id')) echo 'error'; ?>">
                                                        <label>Clinic Address<span class="required">*</span></label>
                                                        <div class="controls">
                                                            <select class="select2 form-control" id="address_id" name="address_id" required >
                                                                <option value="">Select Address</option>
                                                                @foreach($ClinicDoctors as $ClinicDoctor)
                                                                @isset($ClinicDoctor->clinic)
                                                                    <option  value="{{$ClinicDoctor->clinic->address_id}}">{{$ClinicDoctor->clinic->name}}</option>
                                                                @endisset    
                                                                @endforeach
                                                            </select>
                                                            @if($errors->has('address_id'))
                                                                <div class="help-block text-danger address_id-shopwoo-error">
                                                                    <ul role="alert">
                                                                        <li>{{$errors->first('address_id')}}</li>
                                                                    </ul>
                                                                </div>
                                                            @endif
                                                        </div>
                                                    ...
                                                    {{--<div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12 <?php if ($errors->has('street1')) echo 'error'; ?>">
