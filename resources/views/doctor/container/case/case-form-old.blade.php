                                            ...
                                            <div class="card-body card-dashboard">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-12 <?php if ($errors->has('comment')) echo 'error'; ?>">
                                                        ...
                                                        <input class="form-control" placeholder="Embedded URL">
                                                        

                                                    </div>

                                                    <div class="form-group col-12 <?php if ($errors->has('comment')) echo 'error'; ?>" id="other-files">
                ...
                success:function(responseCollection){
                    ...
                    if(type == "OTHER"){
                        $file = '<div class="btn" id="destroy_attachment_'+id+'"><a href="'+full_path+'" target="_blank">'
                                +'    <img src="{{asset("link/files/app-assets/images/file.png")}}" alt="Image" class="img-thumbnail"></a>'
