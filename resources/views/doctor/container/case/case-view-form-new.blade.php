        ...
        <div class="row">
            <div class="col-xl-12 yellowcolor py-3">
                <div class="row ">
                    ...
                    <div class="col-xl-3 mt-2 text-right">
                        <div class="  @if (isset($order))ViewDetails @else orderactive   @endif">
                            @if(isset($order))
                                <a class="text-white cursor float-right mx-3 py-2 px-3"
                                   onclick="view('{{ $order->id }}') ">View
                                    Details</a>
                            @else
                                <a class="mt-2 px-3 py-2">Pending</a>
                            @endif
                        </div>
                    </div>
                                ...
                                <div class="col-xl-12 py-2 ">
                                    @if ($edit_values->video_uploaded_type == 'VIDEO')
                                        <video id="vid0" src="{{ storageUrl_h($edit_values->video_uploaded) }}"
                                               style="width:100% !important;" controls="controls"
...
<?php
                        ...
                        <div class="row mt-1 " style="background:#f8fbff;">
                            <div class="col-md-12 p-0 px-2   borderbottom pb-3">
                                <div class="row py-2 m-1"
                                     style="border:1px solid rgb(232, 232, 232);border-radius: 8px;">
                                    ...
                                    <div class="col-md-3 col-3 p-0 pt-3 col">
                                        @if ($edit_values->digital_scan_fee != 0 && $edit_values->pay_digital_scan != 0)
                                            <a class="painbtn  " style="padding:6px 8px!important;font-size: 12px;">
                                                Delivered</a>
                                        @else
                                            ...
                                            @endif
                                            <a class="inprogressbtn  "
                                               style="padding:6px 8px!important;font-size: 12px;"> Pending</a>
                                        @endif
                                        <p class="mt-2" style="font-size: 15px;font-weight: bold;">
                                            {{ $edit_values->processing_fee_amount }} <span
                                                style="font-size: 12px;font-weight:300;">{{ strtoupper($currency) }}</span>
                                        </p>
                                    </div>
                        ...
                        <div class="row mt-4 ">
                            ...
                            <div class="col-md-12   p-0 px-3  pb-3">
                                ...
                                <input type="text" name="no_of_trays" id="no_of_trays" class="form-control"
                                       ...
                                       readonly
                                       @if (isset($edit_values->aligner->status) && strtoupper($edit_values->aligner->status) != 'PENDING') readonly
                                       title="Can not update, order has been paid" @endif>
                            </div>
                            ...
                            <div class="col-md-12  py-3">
                                @if (false)
                                    <button class="bgcolor float-right px-3 py-3 text-white" id="no_of_days_button">
                                        Submit
                                    </button>
                                @endif
                ...
                <div
                    class="{{ !empty($edit_values->video_uploaded) || (!empty($edit_values->video_embedded) && !empty($edit_values->no_of_trays) && $edit_values->no_of_trays > 0) ? '' : 'main-container' }}">
                    <div class="row mt-3 m-0">
                                ...
                                <div class="row borderbottom pb-4">
                                    <div class="col-md-2 p-0">
                                        <div class="c1data px-3 py-3 m-2">
                                            <p style="color: #4B5563;font-size:12px;" class="mt-2 m-0"> Arch to
                                                treat</p>
                                            <h5 class="pt-2"
                                                style="color: black;font-size:12px;">{{ $edit_values->arch_to_treat }}
                                            </h5>
                                    ...
                                    <div class="col-md-2 p-0">
                                        <div class="c1data px-3 py-3 m-2">
                                            ...
                                            <h5 class="pt-2"
                                                style="color: black;font-size:12px;">{{ $edit_values->overjet }}</h5>
                                    ...
                                    <div class="col-md-2 p-0">
                                        <div class="c1data px-3 py-3 m-2">
                                            <p style="color: #4B5563;font-size:12px;" class="mt-2 m-0"> Arch to
                                                treat</p>
                                            <h5 class="pt-2"
                                                style="color: black;font-size:12px;">{{ $edit_values->overbite }}</h5>
                                    ...
                                    <div class="col-md-2 p-0">
                                        <div class="c1data px-3 py-3 m-2">
                                            ...
                                            <h5 class="pt-2"
                                                style="color: black;font-size:12px;">{{ $edit_values->midline }}</h5>
                                    ...
                                    <div class="col-md-12 crowding">
                                        ...
                                        @isset($edit_values->clinical_conditions)
                                            @foreach ($edit_values->clinical_conditions as $clinical_condition)
                                                <button
                                                    class="mt-3"> {{ ucwords($clinical_condition->clinical_condition->name) }}
                                                </button>
                                            @endforeach
                                        @endisset
                                    </div>
                    ...
                    border: 1px solid #d0d0d0;border-radius:8px;">
                                    ...
                                    <div class="col-md-6 p-2 p-0 aresure  bold m-auto">
                                        ...
                                        <span style="font-weight:bold;font-size: 13px;"
                                              id="item_name">Clears Aligner</span>
                                    </div>
                            ...
                            <div class="col-md-12 delebtn" style="padding:21px !important;">
                                <button class="btn  text-white bgcolor float-right d-none"
                                        id="pay_now_invoice">Submit
                                </button>
                                <button class="btn  text-white bgcolor float-right stripe-div" id="pay_now"
                                        style="margin-top: 17px;">Pay Now
                                </button>
                                <a class="btn cancelbtn  text-white  float-right stripe-div"
                                   onclick="bndka1();">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
