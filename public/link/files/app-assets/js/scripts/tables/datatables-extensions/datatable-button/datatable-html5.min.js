$(document).ready(function () {
    ...
    $('.ideaecom-datatable-pag').DataTable( {
        dom: 'Bfrtip',
        paging:false,
        filter:false,
        responsive:true,
    ...
    $(".dataex-html5-export").DataTable({
        ...
        dom: "Bfrtip",
        buttons: [{
            extend: "excelHtml5", customize: function (t) {
                var e = t.xl.worksheets["sheet1.xml"];
                $('row c[r^="F"]', e).each(function () {
                    5e5 <= 1 * $("is t", this).text().replace(/[^\d]/g, "") && $(this).attr("s", "20")
                })
            }
        }]
        ...
        dom: "Bfrtip", buttons: [{
            extend: "pdfHtml5", customize: function (t) {
        ...
        dom: "Bfrtip", buttons: [{
            text: "JSON", action: function (t, e, a, A) {
