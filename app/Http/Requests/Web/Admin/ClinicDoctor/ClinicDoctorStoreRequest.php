...
class ClinicDoctorStoreRequest extends FormRequest
{
    /**
    ...
    {
        return [
            "doctor_id" => 'required|exists:users,id,user_type,doctor|unique:clinic_doctors,doctor_id,NULL,id,deleted_at,NULL,clinic_id,'.$this->route('clinic'),
